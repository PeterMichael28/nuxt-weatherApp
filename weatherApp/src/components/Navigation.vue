<template>
  <header class="sticky top-0 bg-pry shadow-lg">
    <nav class="container flex flex-col sm:flex-row items-center gap-4 text-white py-6">
      ...
      <div class="flex gap-3 flex-1 justify-end">
        <i
          class="fa-solid fa-circle-info text-3xl hover:text-sec transition-all duration-300 cursor-pointer"
         
        ></i>

        <i
          class="fa-solid fa-plus text-3xl hover:text-sec transition-all duration-300 cursor-pointer"
